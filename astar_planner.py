    ...
    def plan(self, start_state, dest_state):
        ...
        while Q:
            ...
            for ns in self.get_neighboring_states(s):
                ...
                astar_d = sqrt((dest_state.x - ns.x) ** 2 + (dest_state.y - ns.y) ** 2)
                alternative_best_dist_ns = best_dist_found[s.x, s.y] + transition_distance + astar_d
